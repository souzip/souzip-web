<template>
  <div class="min-h-screen bg-white">
    ...
    <section id="download" class="py-16 md:py-24 px-4 bg-white">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 lg:gap-12">
          <!-- iOS 다운로드 -->
          <div class="flex flex-col items-center space-y-3 md:space-y-4 w-full md:w-auto">
            <a 
              :href="appStoreUrl"
              target="_blank"
              rel="noopener noreferrer"
              class="flex items-center gap-3 md:gap-4 px-6 md:px-8 py-3 md:py-4 bg-black text-white rounded-xl hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl w-full md:w-auto justify-center"
            >
              <svg class="w-8 md:w-10 h-8 md:h-10" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div class="text-left">
                ...
                <div class="text-lg md:text-xl font-semibold">App Store</div>
              </div>
            </a>
            <div class="bg-white py-6 px-3 md:p-4 rounded-2xl shadow-md w-full md:w-auto flex justify-center">
              <img 
                :src="appStoreQR" 
          ...
          <div class="flex flex-col items-center space-y-3 md:space-y-4 w-full md:w-auto">
            ...
            >
              ...
              <div class="text-left">
                ...
                <div class="text-lg md:text-xl font-semibold">Google Play</div>
              </div>
            </a>
            <div class="bg-white py-6 px-3 md:p-4 rounded-2xl shadow-md w-full md:w-auto flex justify-center">
              <img 
...
const appStoreQR = computed(() => {
  return `https://quickchart.io/qr?text=${encodeURIComponent(appStoreUrl)}&size=250`
})

const playStoreQR = computed(() => {
  return `https://quickchart.io/qr?text=${encodeURIComponent(playStoreUrl)}&size=250`
})
